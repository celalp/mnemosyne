...
def process_pdf(pdf, lp_model, vl_model, figure_prompt, table_prompt, interpret_figures=True, interpret_tables=True,
                zoomx=2, device="cuda", max_tokens=400):
    """
    ...
    :param device: cuda for gpu or cpu for cpu
    :param max_tokens:
...
def image_embeddings(images, model_dir, device="cuda:0"):
...
def text_embeddings(text, params, splitting_strategy="semantic"):
